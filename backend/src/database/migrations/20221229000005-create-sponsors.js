...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.createTable('sponsors', {
      ...
      responsibleName: {allowNull: true, field: 'reponsible_name', type: Sequelize.STRING},
      responsibleEmail: {allowNull: true, field: 'reponsible_email', type: Sequelize.STRING},
      responsiblePosition: {allowNull: true, field: 'reponsible_position', type: Sequelize.STRING},
      responsiblePhone: {allowNull: true, field: 'reponsible_phone', type: Sequelize.STRING},
      responsibleMobile: {allowNull: true, field: 'reponsible_mobile', type: Sequelize.STRING},
      ...
      cnpjId: {allowNull: true, field: 'cnpj_id', type: Sequelize.INTEGER, references: {model: 'cnpjs', key: 'id'}, onUpdate: 'CASCADE', onDelete: 'CASCADE'},
